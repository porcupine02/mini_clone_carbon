...
from .views import ProjectView, ProjectByIdView, FormSubmissionView, FormSubmissionByIdView, FormFieldResponseView, FormFieldResponseByIdView, AssignSubmissionView, FormSubmissionDetailView, GetSubmissionsByFormIdView, ProjectBySubjectView, AssignmentForTeacherBySubjectView
...
urlpatterns = [
    ...
    path('subject/assignment-teacher/<int:subject_id>', AssignmentForTeacherBySubjectView.as_view(), name='assignments_for_teacher_by_subject'),
]